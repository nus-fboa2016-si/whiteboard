...
This is the last in a series of four tutorials that walk you through the creation of a real-time collaborative whiteboard with Socket.IO. A fully featured demo can be found [here](https://socket-io-whiteboard.herokuapp.com/).
...
We are now at the final tutorial of this guide, so let us end on a special note. Up till now we have only been working with 2D graphics. If you've played with the [demo](https://socket-io-whiteboard.herokuapp.com/) then you've noticed the most glaring difference between it and our own whiteboard: fancy 3D particle effects. 
